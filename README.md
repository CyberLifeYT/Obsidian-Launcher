...
![Obsidian Launcher Screenshot](screenshots/launcher_main.png)
...
- .NET Desktop Development workload (or .NET 8 SDK)
...
### Steps
```bash
git clone https://github.com/YOUR_USERNAME/ObsidianLauncher.git
cd ObsidianLauncher
# Open ObsidianLauncher.sln in Visual Studio
